...
* **database:** add Client model and update License relation ([c8fd953](https://github.com/raulgcode/licensebox/commit/c8fd953328e16bc03e054779b91f64d28bd77bee))
* **database:** add UUID support for client and license creation in seed script ([7120cf8](https://github.com/raulgcode/licensebox/commit/7120cf8889c82b6871e377461fc61021746468b3))
...
* fix lint and deploy api ([7d6963e](https://github.com/raulgcode/licensebox/commit/7d6963eb9025290328a8f5ebadf1060c271a72a4))
* Implement client secret management with rate limiting and regenerate functionality ([6bd29bf](https://github.com/raulgcode/licensebox/commit/6bd29bf3c0ae82da2d041cc92598c98a9043621f))
...
* update tsconfig to include prisma directory and restore rootDir option ([132d186](https://github.com/raulgcode/licensebox/commit/132d186e314c417105c72611ca9c72e967b8eed6))
